...
from src.base_project.__app_name__ import APP_NAME
from src.base_project.__version__ import __version__
from src.base_project.config import settings_generator
from src.base_project.info import APP_NAME_PATH, LOGGING_CONFIGURATION_PATH, LOGS_PATH, PYPROJECT, VERSION_PATH
...
def build_executable_gui():
    ...
    pyin_run(
        [
            "src/base_project/load_gui.py",
            "--onedir",
            "--windowed",
            "--add-data=src/base_project/*:.",
